...
const en = {
  ...
  editor: {
    title: 'Edit Card',
    desc: 'Editing this card updates the local copy. Re-add to AnkiDroid to sync the remote note.',
    front: 'Front *',
    back: 'Back / Extra *',
    tags: 'Tags',
    required: 'Front and back are required.',
    updated: 'Card updated. Re-sync to AnkiDroid in the entry screen.',
    saveFailed: 'Failed to save card',
